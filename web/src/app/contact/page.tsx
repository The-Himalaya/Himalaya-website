...
export default function Contact() {
  ...
  const onSubmit = async (data: ContactFormData) => {
    ...
    analytics.contactSubmit(data.subject);
    setIsSubmitted(true);
    setTimeout(() => setIsSubmitted(false), 3000);
  };

  const phoneDetails = [s.phone, s.phone2].filter(Boolean);
  const phoneLinks = phoneDetails.map((p) => `tel:${p!.replace(/\s/g, '')}`);

  const contactInfo = [
    {
      icon: MapPin,
      title: 'Address',
      details: [fullAddress(s)],
    },
    {
      icon: Phone,
      title: 'Phone',
      details: phoneDetails as string[],
      links: phoneLinks,
    },
    ...(s.email ? [{
      icon: Mail,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="bg-[var(--himalaya-card)] border border-[var(--border)] rounded-lg overflow-hidden mb-6 h-80">
                <iframe
                  src={s.map_embed_url || 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1837.2227826063802!2d72.67824077683828!3d22.933812165135745!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e8956cfb996f9%3A0xa92da8302e1ebca3!2sAkberali%20Precast%20Pvt%20Ltd%20(HIMALAYA)!5e0!3m2!1sen!2sin!4v1775295510814!5m2!1sen!2sin'}
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
